...
web/             Frontend (Vite + React + TypeScript)
  ...
  src/components/   Composants de présentation (Player, Pips, SearchAutocomplete, History, Result, ShinyText, GenerationFilter, RandomSetup, ProfileEditor, PlayerAvatar, CareerHub, StatBars)

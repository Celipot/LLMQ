...
server/          Backend Express (JS, CommonJS)
  ...
  career.js         Règles pures du Mode Carrière (stats par paliers de 100, énergie, 2 phases de 10 tours, single, album, concert)
  careerRounds.js   Lien session solo ↔ gameState ↔ career (démarrage/règlement des rounds d'étude, de single, d'album et de concert)
...
web/             Frontend (Vite + React + TypeScript)
  ...
  src/components/   Composants de présentation (Player, Pips, SearchAutocomplete, History, Result, ShinyText, GenerationFilter, RandomSetup, ProfileEditor, PlayerAvatar, CareerHub, CareerObjective, CareerResult, CareerScore, StatBars)

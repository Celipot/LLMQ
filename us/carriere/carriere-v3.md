...
- **Fans du premier concert** : 350 fans au tour 20 (un album parfait en donne 300, il faut encore deux singles trouvés au premier essai, 40 chacun, avant et après l'album ; un album B n'en donne que 150).
...
- **Illustration du round** : l'illustration de la carrière, sauf pour un round d'album, où la cover de l'album (`web/public/units/<unité>/album.png`) la remplace, un round de concert, où c'est `web/public/units/<unité>/concert.png`, un round « Se faire connaître », où c'est `web/public/units/<unité>/single.png`, et le SIF, où c'est `web/public/sif-illustration.png`.
